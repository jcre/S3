...
describeSkipIfNotMultiple('MultipleBackend put object', () => {
    withV4(sigCfg => {
        beforeEach(() => {
...
describeSkipIfNotMultiple('MultipleBackend put object based on bucket ' +
'location', () => {
    withV4(sigCfg => {
...
describeSkipIfNotMultiple('MultipleBackend put based on request endpoint',
() => {
    withV4(sigCfg => {
        before(() => {
            bucketUtil = new BucketUtility('default', sigCfg);
